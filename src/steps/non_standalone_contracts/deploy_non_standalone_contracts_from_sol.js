...
/**
 * sequently deploy non-standalone contracts
 *
 * @param {Chain3} chain3
 ...
 * @throws some non-standalone smart contract deployment failed
 * @returns {Contract[]}
 */
    ...
    return sequentPromises(
      inputs.map(
        ...
        (input, i) => {
          ...
          console.log(
            `gasPrice: ${gasPrice}, gasBudget: ${gasBudget}, inputs: ${JSON.stringify(
              input
            )}`
          );
